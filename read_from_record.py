...
listOfTopics = ['/cam_right/image_raw', '/cam_left/image_raw', '/cam_center/image_raw','/labels/losttc']
cv_bridge = CvBridge()
            ...
            for topic, msg, t in bagContents:
                if topic== '/labels/losttc':
                    ...
                    if ready[0] and ready[1] and ready[2]:
                        ...
                        feature_dict['los'] = feature_int64(msg.x)
                        feature_dict['los_rate'] = feature_int64(msg.y)
                        feature_dict['loom'] = feature_int64(msg.z)
